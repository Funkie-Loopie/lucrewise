...
async function run() {
  for (const service of SERVICES) {
    for (const lang of ['en', 'zh']) {
      ...
      if (!doc) {
        console.log(`  ⚠️  Not found: ${service.slug} (${lang})`)
        continue
      }
      await client
        .patch(doc._id)
        ...
        .commit()
      console.log(`  ✅ Updated: ${data.title} (${lang})`)
    }
  }
  console.log('\n✨ Done!')
}
