    ...
    .items([
      ...
      S.listItem()
        ...
        .child(
          S.documentList()
            .title('Pages')
            .filter('_type == "page" && (slug.current == "home" || slug.current == "about-us-2" || slug.current == "services-2" || slug.current == "blog" || slug.current == "blogs" || slug.current == "博客" || slug.current == "contact-2" || slug.current == "联系我们")')
            .defaultOrdering([
      ...
      S.listItem()
        ...
        .child(
          S.documentList()
            ...
            .filter('_type == "page" && slug.current match "blog-*"')
            .defaultOrdering([{ field: 'language', direction: 'asc' }, { field: 'title', direction: 'asc' }])
        ),
      ...
      S.listItem()
        ...
        .child(
          S.documentList()
            .title('Archive Pages')
            .filter('_type == "page" && slug.current match "*archive"')
            .defaultOrdering([{ field: 'language', direction: 'asc' }, { field: 'title', direction: 'asc' }])
        ),
