...
export async function getSanityPage(slug, language = 'en') {
  ...
  const slugMap = {
    // Root pages
    'home': 'home',
    'about-us': 'about-us', // about-us-2 will be renamed to about-us
    'services': 'services', // services-2 will be renamed to services
    'contact': 'contact', // contact-2 will be renamed to contact
